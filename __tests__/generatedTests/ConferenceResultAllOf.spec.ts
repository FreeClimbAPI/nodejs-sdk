...
describe("ConferenceResultAllOf", () => {
  let model: freeclimb.ConferenceResultAllOf =
    new freeclimb.ConferenceResultAllOf({
  ...
  describe("ConferenceResultAllOf class test", () => {
    it("resolves to the class type upon initialization", () => {
      expect(model).toBeInstanceOf(freeclimb.ConferenceResultAllOf);
    });
  });
