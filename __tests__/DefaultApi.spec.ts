...
describe("DefaultAPI", () => {
  ...
  test("#listAvailableNumbers", async () => {
    ...
    let data = await apiInstance.listAvailableNumbers(
      phoneNumber,
      region,
      country,
      voiceEnabled,
  ...
  test("#listCalls", async () => {
    ...
    const applicationId: Array<string> = [
    ...
    let data = await apiInstance.listCalls(
      active,
      to,
      from,
      status,
  ...
  test("#listConferences", async () => {
    ...
    let data = await apiInstance.listConferences(
      status,
      alias,
      dateCreated,
      dateUpdated,
  ...
  test("#listIncomingNumbers", async () => {
    ...
    let data = await apiInstance.listIncomingNumbers(
      phoneNumber,
      alias,
      region,
      country,
  ...
  test("#listParticipants", async () => {
    ...
    let data = await apiInstance.listParticipants(
      conferenceId,
      talk,
      listen,
      dtmfPassThrough,
  ...
  test("#listRecordings", async () => {
    ...
    let data = await apiInstance.listRecordings(
      callId,
      conferenceId,
      dateCreated,
    );
  ...
  test("#listSmsMessages", async () => {
    ...
    const is10DLC = true;
    let data = await apiInstance.listSmsMessages(
      to,
      from,
      beginTime,
      endTime,
  ...
  test("#updateAnApplication", async () => {
    ...
    let data = await apiInstance.updateAnApplication(
      applicationId,
      applicationRequest,
    );
    expect(data).toBeInstanceOf(ApplicationResult);
  ...
  test("#updateAnIncomingNumber", async () => {
    ...
    let data = await apiInstance.updateAnIncomingNumber(
      phoneNumberId,
      incomingNumberRequest,
    );
    expect(data).toBeInstanceOf(IncomingNumberResult);
  ...
  test("#listConferenceRecordings", async () => {
    ...
    let data = await apiInstance.listConferenceRecordings(
      callId,
      conferenceId,
      dateCreated,
    );
  ...
  test("#createKnowledgeBaseCompletion", async () => {
    ...
    let data = await apiInstance.createKnowledgeBaseCompletion(
      knowledgeBaseId,
      completionRequest,
    );
