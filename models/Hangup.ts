...
interface ArgumentsType {
  /**
    * CodegenProperty{openApiType='string', baseName='reason', complexType='null', getter='getReason', setter='setReason', description='The user defined reason for the hangup. In general, applications should use a set of enumerated values that are predefined to cover all exit points of the Call flows for the given application.', dataType='string', datatypeWithEnum='string', dataFormat='null', name='reason', min='null', max='null', defaultValue='undefined', defaultValueWithParam=' = data.reason;', baseType='string', containerType='null', containerTypeMapped='null', title='null', unescapedDescription='The user defined reason for the hangup. In general, applications should use a set of enumerated values that are predefined to cover all exit points of the Call flows for the given application.', maxLength=null, minLength=null, pattern='null', example='"string_example"', jsonSchema='{
