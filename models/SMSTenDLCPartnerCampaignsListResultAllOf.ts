...
export class SMSTenDLCPartnerCampaignsListResultAllOf {
    ...
    static getAttributeTypeMap(): AttributeType[] {
        return SMSTenDLCPartnerCampaignsListResultAllOf.attributeTypeMap;
    }

    public constructor(args: ArgumentsType) {
        const preparedArgs = SMSTenDLCPartnerCampaignsListResultAllOf.attributeTypeMap.reduce((acc: Partial<ArgumentsType>, attr: AttributeType) => {
