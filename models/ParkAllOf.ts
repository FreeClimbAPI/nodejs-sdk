...
export class ParkAllOf {
    ...
    */
    ...
    static getAttributeTypeMap(): AttributeType[] {
        return ParkAllOf.attributeTypeMap;
    }

    public constructor(args: ArgumentsType) {
        const preparedArgs = ParkAllOf.attributeTypeMap.reduce((acc: Partial<ArgumentsType>, attr: AttributeType) => {
