...
export class AudioStreamWebhook extends Webhook {
  /**
   * Context or reason why this request is being made. Will be audioStream - gRPC session for this Call has ended and its actionUrl is being invoked.
   */
  "requestType"?: string;
  /**
   * Unique ID for this Call, generated by FreeClimb. This is the call leg which ended its gRPC session.
   */
  "callId"?: string;
  /**
  ...
  static getAttributeTypeMap(): AttributeType[] {
    return super
      .getAttributeTypeMap()
      .concat(AudioStreamWebhook.attributeTypeMap);
  }
  public constructor(args: ArgumentsType) {
    super({ requestType: "audioStream" });
    const assign = <T>(attribute: keyof ArgumentsType): T => {
      return (
        args.hasOwnProperty(attribute)
          ? args[attribute]
          : AudioStreamWebhook.attributeTypeMap.find(
  ...
  public static deserialize(payload: string): AudioStreamWebhook {
    return new AudioStreamWebhook(JSON.parse(payload));
  }
}
