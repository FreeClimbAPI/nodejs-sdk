...
interface ArgumentsType {
  /**
    * CodegenProperty{openApiType='boolean', baseName='listen', complexType='null', getter='getListen', setter='setListen', description='Specifying `false` will silence the Conference for this Participant.', dataType='boolean', datatypeWithEnum='boolean', dataFormat='null', name='listen', min='null', max='null', defaultValue='undefined', defaultValueWithParam=' = data.listen;', baseType='boolean', containerType='null', containerTypeMapped='null', title='null', unescapedDescription='Specifying `false` will silence the Conference for this Participant.', maxLength=null, minLength=null, pattern='null', example='true', jsonSchema='{
