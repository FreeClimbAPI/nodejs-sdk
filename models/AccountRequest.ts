...
interface ArgumentsType {
  /**
    * CodegenProperty{openApiType='string', baseName='alias', complexType='null', getter='getAlias', setter='setAlias', description='Description for this account.', dataType='string', datatypeWithEnum='string', dataFormat='null', name='alias', min='null', max='null', defaultValue='undefined', defaultValueWithParam=' = data.alias;', baseType='string', containerType='null', containerTypeMapped='null', title='null', unescapedDescription='Description for this account.', maxLength=null, minLength=null, pattern='null', example='"string_example"', jsonSchema='{
  ...
  alias?: string;
  /**
    * CodegenProperty{openApiType='string', baseName='label', complexType='null', getter='getLabel', setter='setLabel', description='Group to which this account belongs.', dataType='string', datatypeWithEnum='string', dataFormat='null', name='label', min='null', max='null', defaultValue='undefined', defaultValueWithParam=' = data.label;', baseType='string', containerType='null', containerTypeMapped='null', title='null', unescapedDescription='Group to which this account belongs.', maxLength=null, minLength=null, pattern='null', example='"string_example"', jsonSchema='{
  "description" : "Group to which this account belongs.",
  "type" : "string"
}', minimum='null', maximum='null', exclusiveMinimum=false, exclusiveMaximum=false, required=false, deprecated=false, hasMoreNonReadOnly=false, isPrimitiveType=true, isModel=false, isContainer=false, isString=true, isNumeric=false, isInteger=false, isShort=false, isLong=false, isUnboundedInteger=false, isNumber=false, isFloat=false, isDouble=false, isDecimal=false, isByteArray=false, isBinary=false, isFile=false, isBoolean=false, isDate=false, isDateTime=false, isUuid=false, isUri=false, isEmail=false, isPassword=false, isFreeFormObject=false, isArray=false, isMap=false, isOptional=false, isEnum=false, isInnerEnum=false, isEnumRef=false, isAnyType=false, isReadOnly=false, isWriteOnly=false, isNullable=false, isSelfReference=false, isCircularReference=false, isDiscriminator=false, isNew=false, isOverridden=null, _enum=null, allowableValues=null, items=null, additionalProperties=null, vars=[], requiredVars=[], mostInnerItems=null, vendorExtensions={}, hasValidation=false, isInherited=false, discriminatorValue='null', nameInCamelCase='label', nameInPascalCase='Label', nameInSnakeCase='LABEL', enumName='null', maxItems=null, minItems=null, maxProperties=null, minProperties=null, uniqueItems=false, uniqueItemsBoolean=null, multipleOf=null, isXmlAttribute=false, xmlPrefix='null', xmlName='null', xmlNamespace='null', isXmlWrapped=false, isNull=false, isVoid=false, getAdditionalPropertiesIsAnyType=false, getHasVars=false, getHasRequired=false, getHasDiscriminatorWithNonEmptyMapping=false, composedSchemas=null, hasMultipleTypes=false, hasSanitizedName=false, requiredVarsMap=null, ref=null, schemaIsFromAdditionalProperties=false, isBooleanSchemaTrue=false, isBooleanSchemaFalse=false, format=null, dependentRequired=null, contains=null}
     */
  label?: string;
}
