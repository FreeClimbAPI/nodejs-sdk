...
export class OutDialConnectWebhook {
    /**
    ...
    */
    ...
    static readonly discriminator: string | undefined = "outDialConnect";
    ...
    static getAttributeTypeMap(): AttributeType[] {
        return OutDialConnectWebhook.attributeTypeMap;
    }

    public constructor(args: ArgumentsType) {
        const preparedArgs = OutDialConnectWebhook.attributeTypeMap.reduce((acc: Partial<ArgumentsType>, attr: AttributeType) => {
    ...
    static create(args: ArgumentsType): OutDialConnectWebhook {
        return new OutDialConnectWebhook(args)
    }
}

Webhook.register(OutDialConnectWebhook)
