...
export class GetSpeechWebhookRecognitionResult {
    ...
    static getAttributeTypeMap(): AttributeType[] {
        return GetSpeechWebhookRecognitionResult.attributeTypeMap;
    }

    public constructor(args: ArgumentsType) {
        const preparedArgs = GetSpeechWebhookRecognitionResult.attributeTypeMap.reduce((acc: Partial<ArgumentsType>, attr: AttributeType) => {
